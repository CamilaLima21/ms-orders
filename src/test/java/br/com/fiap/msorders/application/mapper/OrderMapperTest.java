...
class OrderMapperTest {
    ...
    void shouldMapDtoToDomain() {
        OrderItemDto itemDto = new OrderItemDto(1L, 1L, 10L, 2, BigDecimal.TEN);
        OrderItem orderItem = new OrderItem(1L, 1L, 10L, 2, BigDecimal.TEN);
    ...
    void shouldMapEntityToDomain() {
        OrderItemEntity itemEntity = new OrderItemEntity(1L, null, 10L, 2, BigDecimal.TEN);
        OrderItem orderItem = new OrderItem(1L, 1L, 10L, 2, BigDecimal.TEN);
    ...
    void shouldMapDomainToDto() {
        OrderItem item = new OrderItem(1L, 1L, 10L, 2, BigDecimal.TEN);
        OrderItemDto itemDto = new OrderItemDto(1L, 1L, 10L, 2, BigDecimal.TEN);
    ...
    void shouldMapDomainToEntity() {
        ...
        when(orderItemMapper.toEntity(eq(item), any(OrderEntity.class))).thenReturn(itemEntity);
